    ...
    <form novalidate="" class="flex-grow mt-28" method="POST">
      <div class="flex flex-col rounded-lg max-w-md p-6 space-y-4 text-center bg-gray-300 mx-auto">
        ...
        <div>
            ...
            <input name= "password" type="password" id="password" placeholder="Password" class="shadow-sm text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
        </div>

        <button name="login" type="submit" class="bg-primary text-xl font-bold p-2 px-4 py-2 rounded-md text-white hover:text-black hover:bg-white">Sign In</button>
        </div>
    </form>
